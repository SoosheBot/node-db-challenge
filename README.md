...
--The difference between relational databases and sql is that the RDBMS is the system -- the database software itself, and SQL is the language used to interact with the system.


- [ ] Why do tables need a `primary key`?
--Tables need a primary key to identify the rows in a table.


- [ ] What is the name given to a table column that references the primary key on another table.
--A Foreign key -- it is the table column that references the primary key of another table.


- [ ] What do we need in order to have a _many to many_ relationship between two tables.
--An intermediary table is needed to have many-to-many relationships between databases.
